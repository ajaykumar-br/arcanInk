            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Link href="/signin">
                <Button
                  variant={"primary"}
                  size="lg"
                  className="flex justify-center items-center h-12 px-6 bg-primary text-primary-foreground"
                >
                  Sign in
                </Button>
              </Link>
              <Link href="/signup">
                <Button
                  variant={"secondary"}
                  size="lg"
                  className="flex justify-center items-center h-12 px-6 bg-secondary text-secondary-foreground"
                >
                  Sign up
                </Button>
              </Link>
          ...
          <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <Card className="p-6 border-2 hover:border-primary transition-colors">
              <div className="flex items-center gap-4">
                ...
                <div className="text-xl font-semibold">Multiplayer Editing</div>
              </div>
              <div className="mt-4 text-muted-foreground">
            ...
            <Card className="p-6 border-2 hover:border-primary transition-colors">
              <div className="flex items-center gap-4">
                ...
                <div className="text-xl font-semibold">Smart Drawing</div>
              </div>
              <div className="mt-4 text-muted-foreground">
